...
demo() {
    ...
    echo "Tokens:      $tokens"
    echo "-------------------------------------------------------------------"
    echo "$tokens" | cargo run -q -p cli emlang/sigil-ultra/sigil-ultra.fgr -n 2>&1 | grep -A 15 "^>" | head -17 | grep -v "warning:"
}
...
echo ""
echo "📚 LEARN MORE"
echo "  Read: emlang/sigil-ultra/SIGIL-ULTRA-README.md"
echo "  Examples: emlang/sigil-ultra/sigil-ultra-gallery.txt"
echo "  Try: cargo run -p cli emlang/sigil-ultra/sigil-ultra.fgr"
echo ""
